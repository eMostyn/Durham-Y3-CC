...
def get_l(c, d, c_dash, d_dash, n, p, P, Q):
    ...
    if gcd == 1:
        ...
        # e = 3
        # found_points = []
        # new_point = mult(p, gcd, P, a)
        # e = 3723
        # while mult(p, e, Q, a) != new_point:
        #     e += 1

        # for i in range(0, gcd):
        #     print(e)
        #     new_mod = int((e + (n * i)) - gcd)
        #     print("new", new_mod)
        #     # print(mult(, new_mod, Q, a)))
        #     print(P)
        #     print(mult(p, new_mod, Q, a))
...
print(get_l(c, d, c_dash, d_dash, n, p, P, QB))
